...
public class DtmOutboxTests : DtmEntityFrameworkCoreTestBase
{
    protected IUnitOfWorkManager UnitOfWorkManager { get; }
    protected IDistributedEventBus DistributedEventBus { get; }
    protected IDtmMsgBarrierManager<IEfCoreDbContext> DtmMsgBarrierManager { get; }
    ...
    public DtmOutboxTests()
    {
        ...
        DtmMsgBarrierManager = ServiceProvider.GetRequiredService<IDtmMsgBarrierManager<IEfCoreDbContext>>();
    }
    ...
    public virtual async Task Should_Not_Insert_Barrier_As_Rollback_If_Trans_Succeeded()
    {
        ...
        {
            var dbContextProvider = ServiceProvider.GetRequiredService<IDbContextProvider<DtmTestDbContext>>();
    ...
    public virtual async Task Should_Support_Multi_Database()
    {
        ...
        using (var uow = UnitOfWorkManager.Begin(new AbpUnitOfWorkOptions(true)))
        {
            ...
            messageInfoModel = bag.TransMessages
                .First(x => x.Value.DbConnectionLookupInfo.DbContextType == typeof(DtmTestDbContext)).Value;
            messageInfoModel2 = bag.TransMessages
                .First(x => x.Value.DbConnectionLookupInfo.DbContextType == typeof(DtmTestDbContext2)).Value;
        }
        ...
        await WithUnitOfWorkAsync(async () =>
        {
            ...
            var dbContextProvider2 = ServiceProvider.GetRequiredService<IDbContextProvider<DtmTestDbContext2>>();
